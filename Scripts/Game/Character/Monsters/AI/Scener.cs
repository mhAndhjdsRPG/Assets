...
public class Scener
{
    ...
    public void ScenerLoop()
    {
        ...
        {
            aI.aStarDestinationStack = aStarPathFindingTool.SumPathFromChunk((ScenesLoadManager.Instance.curScene as BattleScene).roomController.MapChunk, aI.Owner.transform.position, aI.playerTarget.position, 3f);
